<template>
  <div class="w-full h-[100vh]">
    ...
    <div>
      <!--Arrow-btn-->
    <button @click="showTable = !showTable" class="py-1 px-1 bg-red-800 rounded ml-[28rem] mt-2">
  ...
  <!--Liceo-Logo-->
    <div class="flex justify-center">
      <img class="h-[18rem]" src="../assets/librarylogo.png" alt="library logo">
    </div>
  </div>
  <!--Form-->
  ...
  <div class="flex flex-col gap-4 p-6">
    <div class="relative h-11 w-full min-w-[200px]">
      <input
        class="w-full h-full px-3 py-3 font-sans text-sm font-normal transition-all bg-transparent border rounded-md peer border-gray-900 
        border-t-transparent text-gray-950 outline outline-0 placeholder-shown:border placeholder-shown:border-red-950 placeholder-shown:border-t-red-950 
        focus:border-2 focus:border-yellow-600 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-50"
        placeholder=" " v-model="inputValue" type="number" />
      <label
        class="before:content[' '] after:content[' '] pointer-events-none absolute left-0 -top-1.5 flex h-full w-full select-none 
        !overflow-visible truncate text-[11px] font-normal leading-tight text-gray-900 transition-all before:pointer-events-none 
        before:mt-[6.5px] before:mr-1 before:box-border before:block before:h-1.5 before:w-2.5 before:rounded-tl-md before:border-t before:border-l
         before:border-yellow-600 before:transition-all after:pointer-events-none after:mt-[6.5px] after:ml-1 after:box-border after:block after:h-1.5 
         after:w-2.5 after:flex-grow after:rounded-tr-md after:border-t after:border-r after:border-yellow-600 after:transition-all peer-placeholder-shown:text-sm 
         peer-placeholder-shown:leading-[4.1] peer-placeholder-shown:text-red-950 peer-placeholder-shown:before:border-transparent 
         peer-placeholder-shown:after:border-transparent peer-focus:text-[11px] peer-focus:leading-tight peer-focus:text-yellow-600 peer-focus:before:border-t-2 
         peer-focus:before:border-l-2 peer-focus:before:!border-yellow-600 peer-focus:after:border-t-2 peer-focus:after:border-r-2 peer-focus:after:!border-yellow-600 
         peer-disabled:text-transparent peer-disabled:before:border-transparent peer-disabled:after:border-transparent peer-disabled:peer-placeholder-shown:text-red-500">
        STUDENT ID:
      </label>
    </div>
  </div>
